...
#module purge
#module load hpss/hpss gnu/13.2.0 intel/2023.2.0 
...
set odir = /scratch4/NCEPDEV/stmp/${USER}/datm_forcing/DATM/Reanal
set wdir = /scratch4/NCEPDEV/stmp/${USER}/datm_forcing/DATM/Tmp_get
#set odir = /scratch4/NCEPDEV/marine/${USER}/datm_forcing/DATM/Reanal
#set wdir = /scratch4/NCEPDEV/marine/${USER}/datm_forcing/DATM/Tmp_get

set dat = $sdate

if (! -d $wdir) mkdir -pv $wdir
if (! -d $odir) mkdir -pv $odir
...
#-- set the time before 6 hour
    ...
    echo ${rdir}/rh${yy}/${ym}/${dat}/com_gfs_v16.3_gdas.${dat}_${hh}.gdas_flux.tar 
    htar -xvf ${rdir}/rh${yy}/${ym}/${dat}/com_gfs_v16.3_gdas.${dat}_${hh}.gdas_flux.tar ./gdas.${dat}/${hh}/atmos/gdas.t${hh}z.sfluxgrbf000.grib2
    htar -xvf ${rdir}/rh${yyb}/${ymb}/${datb}/com_gfs_v16.3_gdas.${datb}_${hhb}.gdas_flux.tar ./gdas.${datb}/${hhb}/atmos/gdas.t${hhb}z.sfluxgrb${hprep}.grib2
    htar -xvf ${rdir}/rh${yy}/${ym}/${dat}/com_gfs_v16.3_gdas.${dat}_${hh}.gdas_nc.tar ./gdas.${dat}/${hh}/atmos/gdas.t${hh}z.atmf000.nc
    if (-f ./gdas.${dat}/${hh}/atmos/gdas.t${hh}z.sfluxgrbf000.grib2) then
      ...
      htar -xvf ${rdir}/rh${yy}/${ym}/${dat}/com.gdas_v16.3_gdas.${dat}_${hh}.gdas_flux.tar ./gdas.${dat}/${hh}/gdas.t${hh}z.sfluxgrbf000.grib2
      htar -xvf ${rdir}/rh${yyb}/${ymb}/${datb}/com.gdas_v16.3_gdas.${datb}_${hhb}.gdas_flux.tar ./gdas.${datb}/${hhb}/gdas.t${hhb}z.sfluxgrb${hprep}.grib2
      htar -xvf ${rdir}/rh${yy}/${ym}/${dat}/com.gdas_v16.3_gdas.${dat}_${hh}.gdas_nc.tar ./gdas.${dat}/${hh}/gdas.t${hh}z.atmf000.nc
